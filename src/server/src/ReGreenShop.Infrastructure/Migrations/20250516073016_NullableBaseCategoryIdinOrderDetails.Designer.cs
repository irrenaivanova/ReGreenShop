...
namespace ReGreenShop.Infrastructure.Migrations
{
    ...
    [Migration("20250516073016_NullableBaseCategoryIdinOrderDetails")]
    partial class NullableBaseCategoryIdinOrderDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReGreenShop.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("ReGreenShop.Domain.Entities.DeliveryPrice", null)
                        .WithMany("Orders")
